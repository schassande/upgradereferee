...
@Component({
  selector: 'app-ndr-validation',
  templateUrl: './ndr-validation.component.html'
})
export class NdrValidationComponent implements OnInit {

  private readonly role: AppRole = 'NDR';
